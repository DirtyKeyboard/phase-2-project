...
const LocalDetails = () => {
  ...
  return (
    <Container verticalAlign='middle' style={{ margin: '6em 0 3em 0', minHeight: "80vh" }}    >
      {loading ?
        <>
          <LoadingBar />
        ...
        <div className='container'>
          ...
          <Image src={info.strMealThumb} alt={info.strMeal} centered  size='large' />
          <Button color='youtube' style={{ margin: '0.5em 0' }} onClick={() => { setShowVideo(!showVideo) }}><Icon name='youtube' />{showVideo ? 'Hide' : 'Show'} Video</Button>
          <br />
